...
#define THRESHOLD      20     // 8-bit centered samples; adjust based on mic sensitivity
#define SAMPLE_COUNT   8000   // 1 second of audio
#define FRAME_SIZE     128
#define NUM_FRAMES     (SAMPLE_COUNT / FRAME_SIZE)
#define N_MFCC         2     // Must match speech_data.h (zcr, ste)
...
void Capture_MFCC_Lite(int16_t* live_features);
